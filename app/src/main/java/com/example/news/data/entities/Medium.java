...
public class Medium implements Parcelable {
    ...
    private List<NewsDetail> mMediaMetadata;
    ...
    protected Medium(Parcel in) {
        ...
        mMediaMetadata = in.createTypedArrayList(NewsDetail.CREATOR);
    ...
    public List<NewsDetail> getMediaMetadata() {
        return mMediaMetadata;
    }

    public void setMediaMetadata(List<NewsDetail> mediaMetadata) {
